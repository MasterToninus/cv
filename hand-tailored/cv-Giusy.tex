...
\begin{minipage}[t]{0.375\columnwidth}
    \vspace{-1.5em}
    \skill{\faPhone~ Phone (ita)}{(+39)~392~4653417}
    \skill{\faPhone~ Phone (fra)}{(+33)~(0)~749633218}
...
%    {0.25cm}
    ...
    {FNOFI}
    {https://www.fnofi.it/}
    {Disiscrizione a causa dell'incompatibilità dei corsi di formazione in Francia.}

    \block{Altre Competenze } 
      
    \skillbar{Office\footnote{Patente Europea del Computer (ECDL).}}
    {1cm}
    {1cm}
    {0.25cm}
