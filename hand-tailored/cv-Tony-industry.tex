...
\begin{minipage}[c]{0.6\columnwidth}
    ...
    \\
    \flushleft{\normalsize \textit{Former researcher in pure mathematics transitioning to tech, with interests in functional programming, quantum algorithms, high-performance computing, scientific programming and numerical simulations.
    }}
\end{minipage} 
\hfill
\begin{minipage}[t]{0.375\columnwidth}
    ...
    \skill{\faGlobe~ Website}{\href{https://www.antoniomiti.it/}{www.antoniomiti.it}}
...
\begin{minipage}[t]{0.375\columnwidth}
    ...
    \skill{Scientific Publications}{\href{https://scholar.google.com/citations?user=DWKPuJYAAAAJ&hl=it&oi=ao}{8 }}
    \skill{Courses Taught}{\href{https://www.antoniomiti.it/teaching/}{6 (50+ hours) }}
    \skill{Conference Talks}{\href{https://www.antoniomiti.it/research/\#presentations}{20+ }}
