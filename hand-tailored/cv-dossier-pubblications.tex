...
%Header
	\begin{minipage}[c]{0.6\columnwidth}
		...
		\\
		\flushleft{\normalsize \textit{
			Postdoctoral researcher in mathematics specializing in higher geometry, multisymplectic structures, \(L_\infty\)-algebras, and their applications to mathematical physics.}}
	\end{minipage} 
	\hfill
	\begin{minipage}[t]{0.37\columnwidth}
		\skill{Born}{1986 in Milano, Italy }
		\skill{Citizenship}{Italian }
		\skill{Marital Status}{Married, 1 daughter}
	\end{minipage}
	\vspace{-0.25em}
...
%Splash Page
	\begin{minipage}[t]{0.6\columnwidth}
		...
		\voice{Postdoctoral fellow (CIVIS-3i)}
			...
			{Research project \href{https://civis3i.univ-amu.fr/en/antonio-michele-miti}{MultiSymORI} - Multisymplectic geometry: observables, reduction, and numerical Integrators (MSCA-H2020 cofund).
			\vspace{-0.25cm}}
    ...
    \voice{MSCA Seal of Excellence 2026}
        ...
        {Project proposal \emph{GROCOMO-CFT – Groupoid Covariance and Multilocal Observables in Classical Field Theories on Curved Backgrounds} (Horizon Europe MSCA-PF-2025, Univ. Lyon 1) recognised by the European Commission as a high-quality submission and recommended for funding.}
    \voice{Progetto avvio alla ricerca 2025}
        ...
        {Research Grant (2800 euros) supporting the GroCO research project.}
...
%        {\href{mailto:fiorenza@mat.uniroma1.it}{fiorenza@mat.uniroma1.it}}
%        {Università di Roma La Sapienza, Rome, Italy;}
%        {https://www1.mat.uniroma1.it/~fiorenza/}       
%        {\vspace{-0.5cm}}   
%    \voice{Mauro Spera}
%        {\href{mailto:mauro.spera@unicatt.it}{mauro.spera@unicatt.it}}
%        {Department of Mathematics and Physics - UCSC, Brescia, Italy;}
%        {http://docenti.unicatt.it/ita/mauro_spera/}       
%        {\vspace{-0.5cm}}
%    \voice{Marco Zambon}
%        {\href{mailto:marco.zambon@kuleuven.be}{marco.zambon@kuleuven.be}}
%        {Department of Mathematics - KU Leuven, Leuven, Belgium;}
%        {https://perswww.kuleuven.be/~u0096206/}       
%        {\vspace{-0.5cm}}
%    \voice{Christian Blohmann}
%        {\href{mailto:blohmann@mpim-bonn.mpg.de}{blohmann@mpim-bonn.mpg.de}}
%        {Max Planck Institute for Mathematics, Bonn, Germany;}
%        {http://people.mpim-bonn.mpg.de/blohmann/}       
%        {\vspace{-0.5cm}}
%    \voice{Luca Vitagliano}
%        {\href{mailto:lvitagliano@unisa.it}{lvitagliano@unisa.it}}
%        {Department of Mathematics - Universit\'a degli studi di Salerno, Fisciano, Italy;}
%        {http://www.dipmat2.unisa.it/people/vitagliano/www/}       
%        {\vspace{-0.5cm}}
    ...
    \voice{Introduction to pAQFT on flat spacetime}
        {12/2025}
        {Dipartimento di Matematica, Sapienza Università di Roma, Ialy;}
        {https://www.antoniomiti.it/teaching/aqft-2025/}       
        {Co-organization of a 1 month phd-level course by Fabrizio Zanello.}	
	\voice{Diffeological structure of Lagrangian field theories}
		...
		{2 months reading seminar co-organized with Prof. Marco D'Agostino.}
	\voice{Workshop on Multisymplectic Structures in Geometry and Physics}
		{01/2024}
		{Institut Camille Jordan, Université Claude-Bernard Lyon 1, France;}
		{https://math.gmu.edu/~cblacke/lyon.html}       
		{Online 1 day international workshop co-organized with Prof. Leonid Ryvkin and Dr. Casey Blacker.}
	\voice{Workshop on multisymplectic geometry}
		{09/2020}
		{KU Leuven, Leuven, Belgium;}
		{https://wis.kuleuven.be/events/multisymplectic}       
		{2 days international workshop co-organized with Prof. Marco Zambon, held online due to COVID restrictions.}
	...
	Postdoctoral experience (years) & 5 \\
	\hline
	...
	An overview of my bibliometric data can be found at: \url{https://www.antoniomiti.it/bibliometrics/}~.
...
\vspace{1em}
    ...
    \voice{Camille Jordan Institute, Université Lyon 1}
        ...
        {Scientific collaboration with the ICJ mathematical physics group within the "CIVIS-3i secondment" period (5 months).}
    \voice{Department of Mathematics, Universit\'a degli studi di Salerno}
        {02/2026}
        {Fisciano, Italy;}
        {http://geometria.dipmat.unisa.it/events.html}       
        {Scientific collaboration with the Geometry research group and workshop (1 week).}
